...
class StructList[S <: Struct : StructFromSegment : HasStructSize : SetPointerBuilder] extends org.katis.capnproto.runtime.List[S#Builder, S#Reader](ElementSize.INLINE_COMPOSITE) {
